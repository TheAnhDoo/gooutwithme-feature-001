  ...
  return (
    <StyledHome data-testid="container">
      <div className="home-container">
        {bunnyState === "yes" ? <div className="title">Thank Kate, hãy gửi cho em lịch rảnh của em để mình sắp xếp nhé !!!!</div> : <div className="title">Will you go out with me?</div>}
